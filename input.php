                ...
                <form method="POST" action="simpan.php">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="attitude" class="form-control" max="25" min="0" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Kehadiran (0–20):</label>
                            <input type="number" name="kehadiran" class="form-control" max="20" min="0" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Daily Report (0–15):</label>
                            <input type="number" name="daily_report" class="form-control" max="15" min="0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Logbook (0–15):</label>
                            <input type="number" name="logbook" class="form-control" max="15" min="0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Gangguan (0–25):</label>
                            <input type="number" name="gangguan" class="form-control" max="25" min="0" required>
                        </div>
